...
class WarehouseHeader(models.Model):
    ...
    ware_code = models.CharField(max_length=30)
    item_code = models.CharField(max_length=100)
    open_qnty = models.DecimalField(max_digits=18, decimal_places=2, default=0)
    recv_qnty = models.DecimalField(max_digits=18, decimal_places=2, default=0)
    issu_qnty = models.DecimalField(max_digits=18, decimal_places=2, default=0)
    baln_qnty = models.DecimalField(max_digits=18, decimal_places=2, default=0)
