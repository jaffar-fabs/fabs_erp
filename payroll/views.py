...
def dashboard_view(request):
    try:
        ...
        child_menu_data = list(Menu.objects.filter(menu_id__in=menu_ids, parent_menu_id__in= str(menu_ids)).order_by('display_order').values('menu_id', 'screen_name', 'url','parent_menu_id'))
