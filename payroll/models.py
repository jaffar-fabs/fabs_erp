...
class Recruitment(models.Model):
    ...
    name_as_per_pp = models.CharField(max_length=255, null=True, blank=True)
    pp_number = models.CharField(max_length=50, null=True, blank=True)
    pp_exp_date = models.DateField(null=True, blank=True)
    pp_validity_days = models.CharField(max_length=100, null=True, blank=True)
    ...
    basic = models.CharField(max_length=100, null=True, blank=True)
    hra = models.CharField(max_length=100, null=True, blank=True)
    transportation_allowance = models.CharField(max_length=100, null=True, blank=True)
    accommodation = models.CharField(max_length=100, null=True, blank=True)
    telephone = models.CharField(max_length=100, null=True, blank=True)
    additional_duty_allowance = models.CharField(max_length=100, null=True, blank=True)
    other_allowance = models.CharField(max_length=100, null=True, blank=True)
    ...
    agent_charges = models.CharField(max_length=100, null=True, blank=True)
    charges_paid_date = models.DateField(null=True, blank=True)
    pcc_certificate = models.CharField(max_length=255, null=True, blank=True)
    doc_status = models.CharField(max_length=100, null=True, blank=True)
    pre_approval = models.CharField(max_length=100, null=True, blank=True)
    work_offer_letter = models.CharField(max_length=255, null=True, blank=True)
    insurance = models.CharField(max_length=255, null=True, blank=True)
    wp_payment = models.CharField(max_length=255, null=True, blank=True)
    visa_submission = models.CharField(max_length=255, null=True, blank=True)
    ...
    airport = models.CharField(max_length=255, null=True, blank=True)
